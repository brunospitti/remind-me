...
export const defaultLabels = [
  { label: "work", color: labelColors.blue },
  { label: "gym", color: labelColors.salmon },
  { label: "leisure", color: labelColors.englishLavender },
  { label: "shopping", color: labelColors.yellow }
];
